...
QUERY_EXPANSIONS = {
    ...
    "такое": ["компания", "профиль", "деятельность", "business", "scope"],
    "расскажи": ["компания", "профиль", "деятельность", "business", "scope"],
    "кто": ["компания", "профиль", "деятельность", "business", "scope"],
